...
class _OrtuPageState extends State<OrtuPage> {
  ...
  final vaccines = const [
    ...
    Vaccine(name: "DPT-HB 1", id: "dpthb1"),
    Vaccine(name: "DPT-HB 2", id: "dpthb2"),
    Vaccine(name: "DPT-HB 3", id: "dpthb3"),
    Vaccine(name: "DPT-HB L", id: "dpthbl"),
    ...
    Vaccine(name: "Campak L", id: "campakl"),
    Vaccine(name: "BCG", id: "bcg"),
    Vaccine(name: "IPV 1", id: "ipv1"),
    Vaccine(name: "IPV 2", id: "ipv2"),
    Vaccine(name: "ROTAV 1", id: "rotav1"),
    Vaccine(name: "ROTAV 2", id: "rotav2"),
    Vaccine(name: "ROTAV 3", id: "rotav3"),
    Vaccine(name: "PCV 1", id: "pcv1"),
    Vaccine(name: "PCV 2", id: "pcv2"),
    Vaccine(name: "PCV 3", id: "pcv3"),
  ];
