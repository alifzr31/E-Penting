...
class ImunisasiHeader extends StatelessWidget {
  const ImunisasiHeader({
            ...
            child: Column(
              children: [
                ...
                BaseFormField(
                  ...
                  controller: searchImunisasiController,
                  prefixIcon: Icon(
                    MingCute.search_line,
                    size: 18.sp,
                    color: Colors.black,
                  ),
                  onChanged: onSearchImunisasi,
                ),
                SizedBox(height: 6.h),
                Row(
                  children: [
                    Expanded(
                      child: SizedBox(
                        ...
                        child: OutlinedButton(
                          ...
                          onPressed: onPressedImunisasiDateFilter,
                          child:
                              selectedImunisasiDateFilter == null
                                  ...
                                  : Text(
                                    DateFormat(
                                      'MMMM yyyy',
                                    ).format(selectedImunisasiDateFilter!),
                                    style: TextStyle(
                                      fontSize: 12.sp,
                                      fontWeight: FontWeight.w500,
                                    ),
                    ...
                    SizedBox(width: 6.w),
                    Expanded(
                      flex: selectedImunisasiDateFilter == null ? 3 : 2,
                      child: SizedBox(
                        height: 30.h,
